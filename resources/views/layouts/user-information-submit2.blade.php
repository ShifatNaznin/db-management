    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input id="name" name="fullname" type="hidden" placeholder="FullName" class="validate form-control"
            required="">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input id="mobile" type="hidden"placeholder="Phone No" name="phone" class="validate form-control"
            required="">
          <span class="input-focus-effect theme-bg"></span>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input id="email" type="hidden" placeholder="Email" name="email" class="validate form-control" required="">
          <span class="input-focus-effect theme-bg"></span>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <p class="validate form-control"> {{ $item->division }}</p>
